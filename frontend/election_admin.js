...
function printBallotsA4(keysToPrint) {
    ...
    <head>
        ...
        <style>
            ...
            .watermark { position: absolute; top: 25%; left: 50%; transform: translate(-50%, -50%); width: 60%; opacity: 0.12; z-index: 10; pointer-events: none; mix-blend-mode: multiply; }
            ...
            .qr-code { width: 120px; height: 120px; background: #fff; padding: 5px; border: 1px solid #ddd; z-index: 20; position: relative; }
